...
export default function inicio() {
  return (
    <>
        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="text-lg font-medium leading-6 text-gray-900">Dados Básicos</h3>
      ...
      <Link to={`/`}><button className="mt-5 w-full flex justify-center bg-indigo-800  hover:bg-indigo-600 text-gray-100 p-3  rounded-lg tracking-wide font-semibold  cursor-pointer transition ease-in duration-500">
        Voltar
      </button></Link>
    </>
  )
